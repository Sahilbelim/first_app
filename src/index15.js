...
function Card1(props) {
  var icon = `fa-solid fa-2xl my-icon ${props.icon}`;
  return (
  ...
  return (
    <div>
      ...
      <div className="container my-5">
        <div className="row">
          <Card1 icon="fa-bolt" name="Speed" />
          <Card1 icon="fa-shield-halved" name="Security" />
          <Card1 icon="fa-headset" name="Support" />
        </div>
      </div>
      {/* cards  */}
      ...
      <div className="container-fluid py-5 my-5 gl">
        ...
        <div className="row ms-5 mt-5  ">
          <Card2 icon="fa-regular m-5 fa-2xl fa-pen-to-square" />
          <Card2 icon="fa-solid fa-code m-5 fa-2xl" />
          <Card2 icon="fa-solid fa-lightbulb m-5 fa-2xl" />
          <Card2 icon="fa-solid fa-mobile-screen  m-5 fa-2xl" />
        </div>
        <div className="row py-5 ms-5">
          <CardName name="Graphic Design" />
          <CardName name="Development" />
          <CardName name="Digital Marketing" />
          <CardName name="App Design" />
        </div>
      </div>
